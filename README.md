...
Deploy: `npx wrangler pages deploy dist --project-name pocket-writer` (Cloudflare Pages), or push `dist/` to a `gh-pages` branch. Your data lives in your browser; download a backup from Settings.
